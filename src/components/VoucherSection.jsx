...
const VoucherSection = () => {
  ...
  return (
    ...
    <Helmet>
        ...
        <meta name="description" content="Browse all IT certification exam vouchers. Get genuine vouchers for AWS, Microsoft, Google Cloud, CompTIA, Cisco, Red Hat at discounted prices." />
        <meta name="keywords" content="exam vouchers, IT certification, AWS voucher, Microsoft voucher, CompTIA voucher, Cisco voucher" />
        ...
        <meta property="og:description" content="Browse all IT certification exam vouchers with up to 70% discount. Instant delivery." />
      ...
      {vouchersData.slice(1, visibleCount ).map((voucher)=>{
        <ProductSchema key={voucher.id} vouchers={[voucher]}/>
      })}
